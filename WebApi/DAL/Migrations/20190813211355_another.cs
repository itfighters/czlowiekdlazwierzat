        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DotpayLink = table.Column<string>(nullable: true),
                    SiepomagaLink = table.Column<string>(nullable: true),
                    PaypalLink = table.Column<string>(nullable: true),
                    ...
                    Dotpay = table.Column<bool>(nullable: false),
                    Paypall = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, false, "ŚRODKI NA LECZENIE" },
                    { 2, null, false, "ŚRODKI NA NAPRAWY" },
                    { 3, null, false, "POTRZEBNY TRANSPORT" },
                    { 4, null, false, "POTRZEBNI LUDZIE" },
                    { 5, null, false, "POMOC RZECZOWA" },
                    { 6, null, false, "POTRZEBNY DOM" }
                });
