...
class PostForm extends Component {
    constructor (props){
        ...
        this.state = { title: "", image: "", description: "", multichoiceCategories: "", dotpayLink: "", paypalLink: "", siepomagaLink: "", checkboxKonto: "", dateStart: "", dateEnd: "", adressStart: "", adressEnd: "", phone: "" }
    }
    state = { title: "", image: "", description: "", multichoiceCategories: "", dotpayLink: "", paypalLink: "", siepomagaLink: "", checkboxKonto: "", dateStart: "", dateEnd: "", adressStart: "", adressEnd: "", phone: "" }
    ...
    render() {
        const { title, image, description, multichoiceCategories, dotpayLink, paypalLink, siepomagaLink, checkboxKonto, dateStart, dateEnd, adressStart, adressEnd, phone} = this.state;
